...
import 'package:x_prompt/mint_nft/base_nft_mint_repo.dart';
...
class NFTMintRepo extends BaseNFTMintRepo {
  ...
  Future<void> mintNFTOnSolana(
    ...
    final body = json.encode({
      'from': SessionManager.walletAddress,
      'chain': 'SOL',
      'fromPrivateKey': SessionManager.userPrivateKey,
      'to': SessionManager.walletAddress,
      'metadata': {
        'name': name,
        'symbol': symbol,
        ...
        'creators': [
          {
            'address': SessionManager.walletAddress,
            'verified': true,
            'share': 100
          }
        ]
